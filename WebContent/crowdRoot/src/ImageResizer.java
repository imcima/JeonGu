...
public class ImageResizer {
	...
	public static boolean run(String inputFileName, String outputFileName, 
				int outputWidth, float outputQuality) {
		boolean retVal = true;
		try {
			if ( outputWidth < 1 || ( outputQuality < 0.0F ) || ( outputQuality > 1.0F )) {
				retVal = false;
			}else {
				Image inputImage = Toolkit.getDefaultToolkit().getImage( inputFileName );
				checkImage( inputImage );
				Image outputImage = ImageResizer.setSize( inputImage, outputWidth, -1 );
	...
	public static void main( String [] args ) throws java.io.IOException {
		...
		System.out.println( "ImageSizer args[0] : "+ args[ 0 ]);
		System.out.println( "ImageSizer args[1] : "+ args[ 1 ]);
		System.out.println( "ImageSizer args[2] : "+ args[ 2 ]);
		System.out.println( "ImageSizer args[3] : "+ args[ 3 ]);
